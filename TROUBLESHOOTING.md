...
## ❌ Problema
A aplicação MineGuard estava exibindo uma página em branco quando acedida via navegador em `https://localhost:2026`.
...
npm run dev    # Servidor iniciado em https://localhost:2026
```
...
### Aceder à Aplicação
- **URL**: `https://localhost:2026`
- **Porta**: `2026` (conforme `vite.config.ts`)
- **Servidor**: Express com Vite middleware

Como o certificado é autoassinado no ambiente local, aceite o aviso de segurança do navegador na primeira abertura.
